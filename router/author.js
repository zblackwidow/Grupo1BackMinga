...
authorRouter.get('/id/:id',passport.authenticate('jwt', { session: false }),authorById)
...
// delete
authorRouter.delete('/delete',passport.authenticate('jwt', { session: false }),validator(schemaAuthorDelete),deleteAuthor)
